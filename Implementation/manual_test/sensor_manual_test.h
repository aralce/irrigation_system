...
/**Sensor Switch Class test using class sensor pointer
 ...
 * 4) Check that connecting PG2 port to GND turn on the green led. PG2 is configured as a normal_close sensor and the led indicate when sensor is active.
 * 5) Check that connecting PG3 port to GND turn off the red led. PG3 is configured as a normal_open sensor and the led indicate when sensor is active.
 */
